...
<li style="margin:10px">
	<form action="vis" method="GET">
		...
		<select class="form-control" name="projectSelect" id="projectSelect" onchange="clearPageProjectSelected()">
		...
		<div class="well well-sm" style="margin-top:5px;margin-bottom: 2px" id="changesetFromDate"></div>
		...
		<input type="submit" value="Display!" class="btn btn-primary btn-sm btn-block" onclick="abortDevelopers()"/>
	</form>
